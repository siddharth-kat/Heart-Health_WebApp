...
const AssessmentForm = () => {
  ...
  const generateResult = async () => {
    ...
    Given the user's responses, the assessment indicates a potential risk of heart-related problems. Based on the information provided, the overall risk level is evaluated as follows:
    If the levels of cholesterol or bp are high, then the user has a higher chance of getting a heart disease. Evaluate all the metrics; the metrics might not always be the known value. If there's any other info, consider that information too and evaluate the result.
    Recommendations and Insights:
    
    Using the above information, recommend a diet plan or changes in lifestyle to keep a healthy lifestyle or improve his lifestyle.

    This assessment is based solely on the information provided in the health assessment form, and a comprehensive examination by a healthcare professional is crucial for accurate diagnosis and tailored recommendations. Generate the result in a paragraph format of 5-10 lines.
    `;
